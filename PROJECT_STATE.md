...
В этой же ветке уточняется поведение карточек вкладок `Рабочий день` и `Ревью`: кнопка рабочего дня стала одной динамической кнопкой, кнопка начала встречи скрывается до активного рабочего дня, кнопки открытия папок перенесены внутрь раскрытой карточки встречи, карточки встреч стали кликабельными почти всей областью, повторный клик по раскрытой встрече сворачивает ее, блок `Встречи за день` получил `Свернуть`/`Развернуть`, автоматический выбор встречи при старте и завершении созвона убран, чтобы экран не дергался, карточки `Состояние дня` и `Активный созвон` больше не раздуваются по высоте при сворачивании списка встреч и не сжимаются при неактивном рабочем дне, верхние карточки оформлены как парные внутренние панели с одинаковой высотой, статус дня и статус созвона вынесены в заголовки рядом с названиями блоков, видимый путь к папке дня убран из блока `Состояние дня`, окно `Начать встречу` заменено на внутреннюю модалку-overlay с затемнением фона, карточкой с тенью, названием встречи, статусом записи и проверкой пустого названия, встречи на вкладках `Рабочий день` и `Ревью` сортируются свежими сверху, а pipeline раскрытой встречи отображается карточками этапов `OBS запись`, `Аудио`, `Транскрипция`, `Итоги`.
...
- `.venv\Scripts\python.exe -m pytest`: `82 passed`.
