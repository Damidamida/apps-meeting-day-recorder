...
Проверить PR с веткой `codex/floating-meeting-control`: автоматический показ плавающей кнопки, перетаскивание, старт рабочего дня, старт созвона с вводом названия, обязательное подтверждение завершения созвона, скрытие/показ из основного окна и отсутствие блокировки нового созвона фоновым pipeline. Этап 9 не начинать до принятия доработок этапа 8.
