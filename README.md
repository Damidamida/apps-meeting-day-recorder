...
Файл `config.yaml` не добавляется в git. Путь записи настраивается в OBS; приложение сохраняет путь в metadata встречи только если OBS возвращает его после остановки записи.
